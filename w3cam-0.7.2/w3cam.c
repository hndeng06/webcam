...
#define WIDTH_DEFAULT	320			/* default width and height of the image */
...
main (int argc, char *argv[])
{
	...
	char **freqs = NULL;
	char *device = "/var/www/cgi-bin/input.yuv";
...
#define TS_MAX 128
	...
	//printf("palette=%x,VIDEO_PALETTE_YUV420P=%x\n",palette, VIDEO_PALETTE_YUV420P);
	...
	if (form && !protected) {
		...
		#ifdef DEBUG
		printf("get size from form %d x %d \n", width, height);
		#endif
